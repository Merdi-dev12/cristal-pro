      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div>
            ...
            <h1
              class="mt-3 max-w-3xl text-4xl font-semibold tracking-tight text-rheo-dark sm:text-5xl"
            >
            ...
            <p class="mt-5 max-w-2xl text-sm leading-7 text-rheo-muted">
              Sélectionnez le service souhaité, puis créez votre demande en précisant votre besoin.
              L’équipe RHEODYCE pourra ainsi étudier votre dossier et organiser la suite.
            </p>
          </div>
          ...
          <div class="relative overflow-hidden rounded-[30px] bg-[#111711]">
            <img
              ...
              alt="Intérieur immobilier moderne"
              class="h-[360px] w-full object-cover opacity-88 sm:h-[420px]"
            />
            <div
              class="absolute inset-0 bg-gradient-to-t from-[#111711]/88 via-[#111711]/18 to-transparent"
            ></div>
        ...
        <div class="mt-12 overflow-hidden rounded-[30px] border border-rheo-border bg-white">
          <div
            class="grid gap-4 border-b border-rheo-border p-5 sm:grid-cols-[1fr_auto] sm:items-center sm:p-7"
          >
            <div>
              <p class="text-xs font-semibold uppercase tracking-[0.2em] text-rheo-muted">
                Catalogue service
              </p>
              <h2 class="mt-2 text-2xl font-semibold tracking-tight text-rheo-dark">
                Choisissez un service et créez votre demande.
              </h2>
            </div>
          </div>
          ...
          <div class="divide-y divide-rheo-border">
            @for (service of data.services; track service.id; let i = $index) {
              <article
                class="service-row grid gap-5 p-5 transition hover:bg-[#f8f9f5] sm:p-7 lg:grid-cols-[72px_0.8fr_1.35fr_auto] lg:items-center"
              >
                <div
                  class="flex h-12 w-12 items-center justify-center rounded-full bg-rheo-bg text-sm font-semibold text-rheo-dark"
                >
                  0{{ i + 1 }}
                </div>
                <div>
                  ...
                  <h3 class="mt-2 text-xl font-semibold tracking-tight text-rheo-dark">
                    {{ service.title }}
                  </h3>
                </div>
        ...
        <div class="mt-12 grid gap-5 lg:grid-cols-[0.8fr_1.2fr] lg:items-stretch">
          <div class="rounded-[28px] bg-[#111711] p-7 text-white sm:p-8">
            ...
            <h2 class="mt-4 text-3xl font-semibold tracking-tight">
              Un dossier immobilier doit rester compréhensible.
            </h2>
            <p class="mt-5 text-sm leading-7 text-white/62">
              Les services sont organisés pour éviter l’effet catalogue : chaque demande part d’un
              bien, d’un contexte, puis d’une action claire.
            </p>
          </div>
